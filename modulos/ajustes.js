// INÍCIO DO ARQUIVO modulos/ajustes.js - v1.0.7
Vue.component('tela-ajustes', {
    ...
    <div class="container animate__animated animate__fadeIn" v-if="$root.usuario" style="padding-bottom: 100px;">
        ...
        <div style="display: grid; grid-template-columns: 1fr; gap: 12px;">
            ...
            <button v-if="$root.usuario.permissoes.admin || $root.usuario.permissoes.avisos" @click="$root.mudarTela('tela-ajustes-avisos')" class="btn-ajuste">
                <i class="fas fa-bullhorn" style="color: #FFAB00;"></i>
            ...
            const htmlNovidades = `
                <div style="text-align: left; font-size: 0.9rem; line-height: 1.5; color: #CCC;">
                    ...
                    <ul style="padding-left: 20px; margin-bottom: 20px;">
                        <li><b style="color: #00E676;">Mural de Avisos:</b> O módulo de avisos voltou! Agora você pode escolher quem vai ver o aviso (Público-alvo).</li>
                        <li><b style="color: #00B0FF;">Cargo Administrador:</b> O cargo Administrador agora é oficial na criação de novos membros da equipa.</li>
                    </ul>
                </div>
            `;
            Swal.fire({ 
    ...
    mounted() {
        if (!document.getElementById('css-ajustes-v107')) {
            const style = document.createElement('style'); 
            style.id = 'css-ajustes-v107';
            style.innerHTML = `
                .btn-ajuste { width: 100%; background: #1A1A1A; border: 1px solid #333; padding: 20px 15px; border-radius: 12px; display: flex; align-items: center; cursor: pointer; transition: 0.2s; } 
