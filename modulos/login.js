...
Vue.component('tela-login', {
    ...
    <div class="container animate__animated animate__fadeIn" style="display: flex; flex-direction: column; justify-content: center; min-height: 95vh;">
        ...
        <div v-if="$root.carregandoDados" class="animate__animated animate__fadeIn" style="text-align: center; padding: 40px 0;">
            <i class="fas fa-circle-notch fa-spin" style="font-size: 3.5rem; color: #FFAB00; margin-bottom: 20px;"></i>
            <h3 style="color: white; margin: 0; letter-spacing: 1px;">Sincronizando...</h3>
            <p style="color: #888; font-size: 0.85rem; margin-top: 5px;">Baixando dados da Pizzaria</p>
        </div>
